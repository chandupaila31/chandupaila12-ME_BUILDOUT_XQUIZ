...
public class Quiz {
    ...
    public void addQuestion(Question question) {
        if (question == null) {
            ...
            if (this.questions != null) {
                ...
                System.err.println("Questions list was not initialized. Cannot add question.");
            }
        }
    }
    ...
    public void attemptQuiz() {
        ...
        for (int i = 0; i < questions.size(); ++i) { //Iterates over the list of Questions
            ...
            System.out.println("\nQuestion " + (i + 1) + ": " + questions.get(i).getQuestionText());
            for (int j = 0; j < questions.get(i).getChoices().size(); j++) {
                System.out.println((j + 1) + ". " + questions.get(i).getChoices().get(j));
            }
